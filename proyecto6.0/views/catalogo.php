...
<head>
  ...
  <link rel="stylesheet" href="../assets/camilo/CSS/proyecto.css">
...
<body>
  <header class="navbar navbar-expand-sm fondoHeader">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="#">
        <img class="logo" src="../assets/camilo/Pictures/logo sin fondo.png" alt="">
      </a>
      <!--Icono menu-->
  ...
  <a href="carrito.php">
    <img src="../assets/camilo/Pictures/carrito-de-compras.png" alt="Carrito de compras" class="logocar">
          ...
          <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="../assets/camilo/Pictures/IMGP7944.avif" class="d-block w-100" alt="Juguetes para mascotas"
              ...
              <div class="carousel-item">
                <img src="../assets/camilo/Pictures/productos-para-mascotas.jpg" class="d-block w-100" alt="Accesorios para mascotas"
                  style="width: 100%; height: 300px;">
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <img src="../assets/camilo/Pictures/fotolia_131689630.jpg" class="d-block w-100" alt="Higiene de mascotas"
                  style="width: 100%; height: 300px;">
                <div class="carousel-caption d-none d-md-block">
              ...
              echo '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                            <div class="card" style="width: 18rem; margin:auto;">
                              ...
                              <div class="card-body" style="background-color: #ee8133;">
                                  <h3 class="card-title">' . htmlspecialchars($producto['Nombre_P']) . '</h3>
                                  ...
                                  <form action="../index.php?controller=catalogo&action=AñadirCarrito" method="POST">
